...
def blockchain():
    ...
    block_0 = Block(timestamp=1670710843.370897, transaction_hash=transaction_data_1_bytes)
    ...
    block_1 = Block(
        timestamp=1670710945.718833,
        transaction_hash=transaction_data_2_bytes,
    ...
    block_2 = Block(
        timestamp=1670711012.514417,
        transaction_hash=transaction_data_3_bytes,
